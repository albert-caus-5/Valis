...
PATH_HE_ETIQUETES = "/mnt/work/users/josep/WSI/HEinferenceDisplay/"
...
def processar_cas(nom_cas):
    ...
    for idx_he, imatge_he in enumerate(imatges_he):
        for imatge_ihc in imatges_ihc:
            ...
            he_etiquetes =  os.path.join(PATH_HE_ETIQUETES, imatge_he + "_maskV.png")
            registre = Register(imatges_a_registrar, directori_individual, TIPUS_REGISTRE, ref_img, he_etiquetes)
