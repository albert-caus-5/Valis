...
''' Use Examples:
python interfaceinTerminal.py register n_images normal /path/to/image1 nom_ref_img /path/to/image2 /path/to/save
...
def register_images(args):
    ...
    img_etiquetes_he = args.img_etiquetes_he
    ...
    register = Register(image_paths, save_dir, registration_type, ref_img, img_etiquetes_he)
...
if __name__ == "__main__":
    ...
    parser_register.add_argument('img_etiquetes_he', help="Indicar el path a la imatge d'etiquetes d'HE)")
