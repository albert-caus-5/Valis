...
class Register:
    def __init__(self, image_paths, save_results_dir, registration_type, reference_img):
    ...
    def registration(self, transfer = None, source_image_path=None, target_image_paths=None):
        ...
        registrar = registration.Valis(src_paths = self.image_paths, dst_dir = self.save_results_dir, reference_img_f = self.reference_img)
